...
public class PlotBiomeChangeEvent extends PlotEvent implements Cancellable {
    ...
    public PlotBiomeChangeEvent(PlotMe_Core instance, org.bukkit.World world, Plot plot, org.bukkit.entity.Player player, Biome biome) {
    ...
    public PlotBiomeChangeEvent(PlotMe_Core instance, World world, Plot plot, Player player, IBiome biome) {
        super(instance, plot, world);
