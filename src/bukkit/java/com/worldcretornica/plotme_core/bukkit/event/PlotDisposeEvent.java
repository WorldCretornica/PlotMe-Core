...
public class PlotDisposeEvent extends PlotEvent implements Cancellable {
    ...
    public PlotDisposeEvent(PlotMe_Core instance, org.bukkit.World world, Plot plot, Player disposer) {
        super(instance, plot, world);
        event = new InternalPlotDisposeEvent(instance, new BukkitWorld(world), plot, new BukkitPlayer(disposer));
    }

    public PlotDisposeEvent(PlotMe_Core instance, World world, Plot plot, IPlayer disposer) {
        super(instance, plot, world);
