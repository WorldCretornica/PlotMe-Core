...
public class PlotProtectChangeEvent extends PlotEvent implements Cancellable {
    ...
    public PlotProtectChangeEvent(PlotMe_Core instance, org.bukkit.World world, Plot plot, Player player, boolean protect) {
        super(instance, plot, world);
        event = new InternalPlotProtectChangeEvent(instance, new BukkitWorld(world), plot, new BukkitPlayer(player), protect);
    }

    public PlotProtectChangeEvent(PlotMe_Core instance, World world, Plot plot, IPlayer player, boolean protect) {
        super(instance, plot, world);
